...
const LOCATIONS = [
  {
    ...
    drops: ["Jabłko","Słoma","Leśna Przepustka","Skrzynka z Łupem","Bandaż","Deska","Siano","Gwóźdź"],
  ...
  },
  {
    ...
    drops: ["Jabłko Sfinksa","Pustynna Przepustka","Eliksir Szybkości","Skrzynka z Łupem","Jabłko","Kamień","Gwóźdź","Siano"],
    dropWeights: [20, 8, 25, 15, 32],
    reward: "rare",
    rewardPass: "Pustynna Przepustka",
    passChance: 0.06,
    requires: { stat: "stamina", value: 20, label: "Wytrzymałość ≥ 20" },
  ...
  },
  {
    ...
    drops: ["Jabłko Sfinksa","Górska Przepustka","Eliksir Siły","Eliksir Wytrzymałości","Skrzynka z Łupem","Kamień","Metal","Cegła"],
    dropWeights: [25, 8, 25, 22, 20],
    reward: "epic",
    rewardPass: "Górska Przepustka",
    passChance: 0.05,
    requires: { stat: "strength", value: 35, label: "Siła ≥ 35" },
  ...
  },
  {
    ...
    drops: ["Jabłko Sfinksa","Tundrowa Przepustka","Eliksir Odmłodzenia","Skrzynka z Łupem","Kowadło","Metal","Szkło","Kamień"],
    dropWeights: [22, 8, 12, 28, 30],
    reward: "legendary",
    rewardPass: "Tundrowa Przepustka",
    passChance: 0.04,
    requires: { stat: "speed", value: 50, label: "Szybkość ≥ 50" },
  ...
  },
  {
    ...
    drops: ["Jabłko Sfinksa","Mroczna Przepustka","Eliksir Szczęścia","Skrzynka z Łupem","Piorun","Metal","Dachówka","Cegła"],
...
const ITEMS_DATABASE = {
  ...
  "Leśna Przepustka":    { icon:"🌿", desc:"Odblokuj dodatkową wyprawę do Lasu",         rarity:"uncommon", isPass:true, location:"Las Zielony"     },
  "Pustynna Przepustka": { icon:"🌵", desc:"Odblokuj dodatkową wyprawę do Pustyni",       rarity:"rare",     isPass:true, location:"Złota Pustynia"  },
  ...
  // Materiały budowlane
  "Deska":      { icon:"🪵", desc:"Materiał budowlany — rozbudowa stajni", isBuildMat:true },
  "Cegła":      { icon:"🧱", desc:"Materiał budowlany — rozbudowa stajni", isBuildMat:true },
  "Dachówka":   { icon:"🏗️",  desc:"Materiał budowlany — rozbudowa stajni", isBuildMat:true },
  "Gwóźdź":     { icon:"📌", desc:"Materiał budowlany — rozbudowa stajni", isBuildMat:true },
  "Siano":      { icon:"🌾", desc:"Materiał budowlany — rozbudowa stajni", isBuildMat:true },
  "Kamień":     { icon:"🪨", desc:"Materiał budowlany — rozbudowa stajni", isBuildMat:true },
  "Szkło":      { icon:"🪟", desc:"Materiał budowlany — rozbudowa stajni", isBuildMat:true },
  "Metal":      { icon:"⚙️",  desc:"Materiał budowlany — rozbudowa stajni", isBuildMat:true },
...
const SHOP_ITEMS = [
  ...
  // Hodowla — 4% szans na pojawienie się, limit 1-3 sztuki (losowany deterministycznie)
  { name:"Jabłko Sfinksa",      price:1200, icon:"🍏", desc:"Wymagane do rozmnażania",           limitHours:48, limitQtyMin:1, limitQtyMax:3, rareShop:true, rareChance:0.04 },
  { name:"Boski Nektar",        price:1600, icon:"🌟", desc:"+50% szans na mutację",             limitHours:48, limitQtyMin:1, limitQtyMax:2, rareShop:true, rareChance:0.04 },
  { name:"Eliksir Krwi",        price:1000, icon:"🩸", desc:"Potomek dziedziczy krew silniejszego", limitHours:48, limitQtyMin:1, limitQtyMax:2, rareShop:true, rareChance:0.04 },
];
