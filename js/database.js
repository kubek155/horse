const HORSE_DATABASE = {
  common: {
    name: "Pospolite",
    rarity: "common",
    baseStats: { speed: 30, strength: 25, stamina: 28 },
    breeds: ["Konik Polski", "Huculski", "Śląski", "Małopolski", "Wielkopolski"]
  },
  rare: {
    name: "Szlachetne",
    rarity: "rare",
    baseStats: { speed: 50, strength: 45, stamina: 48 },
    breeds: ["Arabski", "Lipicański", "Andaluzyjski", "Lusitano"]
  },
  epic: {
    name: "Bojowe",
    rarity: "epic",
    baseStats: { speed: 70, strength: 68, stamina: 65 },
    breeds: ["Destrier", "Frison", "Kladruber", "Azteca"]
  },
  legendary: {
    name: "Legendarne",
    rarity: "legendary",
    baseStats: { speed: 90, strength: 88, stamina: 85 },
...
const SHOP_ITEMS = [
  ...
  { name: "Skrzynka z Łupem",    price: 200, icon: "📦", desc: "Zawiera: koń (66%), Eliksir Odmłodzenia (14%), eliksir statystyki (20%)",       alwaysAvailable: true },
  { name: "Eliksir Odmłodzenia", price: 800, icon: "🧪", desc: "Odmładza konia o 30–120 dni — RZADKO W SPRZEDAŻY",                             rare: true },
];
